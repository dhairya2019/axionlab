  ...
  return (
    <div className="pt-32 md:pt-64 px-6 md:px-12 overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto mb-48 md:mb-80">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 border border-white/10">
          {[
            ...
            >
              <span className="block font-mono text-accent text-[10px] mb-8 tracking-widest">
                0{i + 1}
              </span>
      ...
      <section id="systems" className="max-w-7xl mx-auto pb-64">
        <h2 className="text-[10px] text-accent font-bold uppercase tracking-[0.6em] mb-20 border-b border-white/10 pb-6">
            ...
            >
              ...
              <div className="relative z-10 space-y-10">
                <div className="space-y-2">
                  <span className="font-mono text-[9px] text-accent font-black tracking-[0.4em]">
                    {system.id}
                  </span>
                ...
                <div className="grid grid-cols-2 gap-y-6 pt-10 border-t border-white/10">
                  <div>
                    <p className="text-[8px] text-muted uppercase tracking-[0.3em] font-black mb-1">
                      Classification
                    </p>
                    <p className="text-[11px] font-bold uppercase text-white tracking-tighter">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-bold uppercase text-accent tracking-tighter">
                      Deployed
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-bold uppercase text-white tracking-tighter whitespace-nowrap overflow-hidden text-ellipsis">
                      {system.architecture}
                    </p>
                  </div>
                </div>
